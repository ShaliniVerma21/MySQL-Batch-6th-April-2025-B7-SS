...
('Bengaluru', 'Known as the Silicon Valley of India, famous for its IT industry and pleasant climate.', 8),
...
('Hyderabad', 'Famous for its historical sites and as a major center for the technology industry.', 8),
('Ahmedabad', 'Known for its rich history and as a major economic hub in Gujarat.', 8),
('Pune', 'Known for its educational institutions and as a growing IT hub.', 8),
('Jaipur', 'The capital city of Rajasthan, known for its historic palaces and vibrant culture.', 8),
('Varanasi', 'One of the oldest cities in the world, known for its spiritual significance and ghats along the 
Ganges.', 8);
